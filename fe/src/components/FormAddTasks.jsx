        ...
        <div className="card-content">
          <div className="content">
            <form onSubmit={saveTasks}>
              ...
              <div className="field">
                <label className="label">Assigned to Moderator</label>
                <div className="control">
                  <div className="select is-fullwidth">
                    ...
                    >
                      ...
                      <option value="moderator2">Moderator 2</option>
                      <option value="moderator3">Moderator 3</option>
                      <option value="moderator4">Moderator 4</option>
                      <option value="moderator5">Moderator 5</option>
                    </select>
                  </div>
                </div>
              </div>
